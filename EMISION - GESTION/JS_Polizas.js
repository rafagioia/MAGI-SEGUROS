  ...
  google.script.run
    .withSuccessHandler(function (result) {
      ...
      for (var i = 0; i < result.length; i++) {
        ...
        pendientesHtml +=
          "<div class='border' style=' margin-bottom: 0;border-radius:5px; padding: 5px 10px 5px 10px; border: 2px solid #000; box-shadow: 0px 0px 5px 0px #000;background-color: " +
          bgColor +
          "' id='div" +
          i +
          ...
          (result[i][5] === "FED PAT"
            ...
            : result[i][5] === "AGROSALTA"
            ? "background-color: #FD964D;"
            : result[i][5] === "AGRO (V)"
            ? "background-color: #FD964D;"
            : result[i][5] === "AGROSALTA C/GRUA"
            ? "background-color: #FD964D;"
            : result[i][5] === "AGRO (V) C/GRUA"
            ? "background-color: #FD964D;"
            : result[i][5] === "RIVADAVIA"
            ? "background-color: #28BEF5;"
            : result[i][5] === "MAPFRE"
            ? "background-color: #CB3234;"
            : result[i][5] === "RIO URUGUAY"
            ? "background-color: #5AC4C3;"
            : result[i][5] === "LIBRA"
            ? "background-color: #FF8000;"
            : result[i][5] === "NIVEL"
            ? "background-color: #F57C00;"
            : result[i][5] === "PROVIDENCIA"
            ? "background-color: #94B3FD;"
            : result[i][5] === "LA CAJA"
            ? "background-color: #EF5350;"
            : result[i][5] === "MERCANTIL"
            ? "background-color: #966CA7;"
            : result[i][5] === "SAN PATRICIO"
            ? "background-color: #EF5350;"
            : result[i][5] === "ATM"
            ? "background-color: #EF5350;"
            : result[i][5] === "BENEFICIO"
            ? "background-color: #9EBAD1;"
            : result[i][5] === "ALLIANZ"
            ? "background-color: #68C1C8;"
            : result[i][5] === "ORBIS"
            ? "background-color: #C8C560;"
            : result[i][5] === "ESCUDO"
            ? "background-color: #9EBAD1;"
            : result[i][5] === "DIGMA"
            ? "background-color: #68C1C8;"
          ...
          "'>" +
          result[i][5] +
          "</div><div class='col-2 modulo' id='dni_" +
          i +
          "'>" +
          result[i][1] +
          "</div><div class='col-4 modulo text-truncate' id='nombre_" +
          i +
          "'>" +
          result[i][2] +
          "</div><div class='col-2 modulo-sm m-0' style='padding-top: 5px;  align: center; width: 150px; color: " +
          txColor +
          "' id='operacion_" +
          i +
          "'>" +
          result[i][9] +
          "</div>" +
          "</div><div class='row p-0 m-0'><div class='col-2 m-0 modulo-sm-pat text-truncate' id='patente_" +
          i +
          "'>" +
          result[i][0] +
          "</div><div class='col-3 modulo-sm text-truncate' id='marca_" +
          i +
          "'>" +
          result[i][11] +
          "</div><div class='col-2 modulo-sm text-truncate' id='vigencia_" +
          i +
          "'>" +
          result[i][7] +
          "</div><div class='col-2 modulo-sm text-truncate' id='hasta_" +
          i +
          "'>" +
          result[i][8] +
          "</div><div class='col-3 modulo-sm text-truncate' id='notas_" +
          i +
          "'>" +
          result[i][13] +
          "</div></div></div><div class=' text-sm text-truncate font-weight-bolder'><div class='row' ></div></div></div>" +
          "<div style='display: none;' id='sucursal_" +
          i +
          "'>" +
          result[i][3] +
          "</div>" +
          "<div style='display: none;' id='importe_" +
          i +
          "'>" +
          result[i][4] +
          "</div>" +
          "<div style='display: none;' id='poliza_" +
          i +
          "'>" +
          result[i][6] +
          "</div>" +
          "<div style='display: none;' id='cobertura_" +
          i +
          "'>" +
          result[i][10] +
          "</div>" +
          "<div style='display: none;' id='fpago_" +
          i +
          "'>" +
          result[i][12] +
          "</div>" +
          "<div style='display: none;' id='danios_" +
          i +
          "'>" +
          result[i][14] +
          "</div>" +
          "<div style='display: none;' id='motor_" +
          i +
          "'>" +
          result[i][15] +
          "</div>" +
          "<div style='display: none;' id='chasis_" +
          i +
          "'>" +
          result[i][16] +
          "</div>" +
          "<div style='display: none;' id='domicilio_" +
          i +
          "'>" +
          result[i][17] +
          "</div>" +
          "<div style='display: none;' id='localidad_" +
          i +
          "'>" +
          result[i][18] +
          "</div>" +
          "<div style='display: none;' id='wpp_" +
          i +
          "'>" +
          result[i][19] +
          "</div>" +
          "<div style='display: none;' id='mail_" +
          i +
          "'>" +
          result[i][20] +
          "</div>" +
          "<div style='display: none;' id='notascte_" +
          i +
          "'>" +
          result[i][21] +
          "</div>" +
      ...
      divs.forEach(function (div) {
        div.addEventListener("click", function () {
          ...
          document.getElementsByName("nombre")[0].value =
            document.getElementById("nombre_" + id).textContent;
          document.getElementsByName("domicilio")[0].value =
            document.getElementById("domicilio_" + id).textContent;
          document.getElementsByName("localidad")[0].value =
            document.getElementById("localidad_" + id).textContent;
          document.getElementsByName("wpp")[0].value = document.getElementById(
            "wpp_" + id
          ).textContent;
          document.getElementsByName("fpago")[0].value =
            document.getElementById("fpago_" + id).textContent;
          document.getElementsByName("mail")[0].value = document.getElementById(
            "mail_" + id
          ).textContent;
          document.getElementsByName("notascte")[0].value =
            document.getElementById("notascte_" + id).textContent;
          document.getElementsByName("patente")[0].value =
            document.getElementById("patente_" + id).textContent;
          document.getElementsByName("marca")[0].value =
            document.getElementById("marca_" + id).textContent;
          document.getElementsByName("cnia")[0].value = document.getElementById(
            "cnia_" + id
          ).textContent;
          document.getElementsByName("vigencia")[0].value =
            document.getElementById("vigencia_" + id).textContent;
          document.getElementsByName("hasta")[0].value =
            document.getElementById("hasta_" + id).textContent;
          document.getElementsByName("cobertura")[0].value =
            document.getElementById("cobertura_" + id).textContent;
          document.getElementsByName("notas")[0].value =
            document.getElementById("notas_" + id).textContent;
          document.getElementsByName("danios")[0].value =
            document.getElementById("danios_" + id).textContent;
          document.getElementsByName("motor")[0].value =
            document.getElementById("motor_" + id).textContent;
          document.getElementsByName("chasis")[0].value =
            document.getElementById("chasis_" + id).textContent;
          document.getElementsByName("importe")[0].value =
            document.getElementById("importe_" + id).textContent;
          document.getElementsByName("sucursal")[0].value =
            document.getElementById("sucursal_" + id).textContent;
          document.getElementsByName("operacion")[0].value =
            document.getElementById("operacion_" + id).textContent;
          document.getElementsByName("poliza")[0].value =
            document.getElementById("poliza_" + id).textContent;
        });
        spinner.style.display = "none";
      });
    })
...
function updateSinPendientes(result) {
  ...
  for (var i = 0; i < result.length; i++) {
    ...
    pendientesHtml +=
      "<div class='border' style=' margin-bottom: 0;border-radius:5px; padding: 5px 10px 5px 10px; border: 2px solid #000; box-shadow: 0px 0px 5px 0px #000;' id='div" +
      i +
      "'><div class='row m-0 p-0'>" +
      "<div class='col-4 cnia_border m-0 text-sm text-truncate' style='" +
      (result[i][5] === "FED PAT"
      ...
      "'>" +
      result[i][2] +
      "</div><div class='col-2 modulo-sm m-0' style='align: center; width: 150px;padding-top: 5px; color: " +
      txColor +
      "' id='operacion_" +
      i +
      "'>" +
      ...
      result[i][6] +
      "</div>" +
      "<div style='display: none;' id='operacion_" +
      i +
      "'>" +
      result[i][9] +
      "</div>" +
  ...
  divs.forEach(function (div) {
    div.addEventListener("click", function () {
      ...
      document.getElementsByName("nombre")[0].value = document.getElementById(
        "nombre_" + id
      ).textContent;
      document.getElementsByName("domicilio")[0].value =
        document.getElementById("domicilio_" + id).textContent;
      ...
      document.getElementsByName("fpago")[0].value = document.getElementById(
        "fpago_" + id
      ).textContent;
      document.getElementsByName("mail")[0].value = document.getElementById(
        "mail_" + id
      ).textContent;
      document.getElementsByName("notascte")[0].value = document.getElementById(
        "notascte_" + id
      ).textContent;
      document.getElementsByName("patente")[0].value = document.getElementById(
        "patente_" + id
      ).textContent;
      document.getElementsByName("marca")[0].value = document.getElementById(
        "marca_" + id
      ).textContent;
      document.getElementsByName("cnia")[0].value = document.getElementById(
        "cnia_" + id
      ).textContent;
      document.getElementsByName("vigencia")[0].value = document.getElementById(
        "vigencia_" + id
      ).textContent;
      document.getElementsByName("hasta")[0].value = document.getElementById(
        "hasta_" + id
      ).textContent;
      document.getElementsByName("cobertura")[0].value =
        document.getElementById("cobertura_" + id).textContent;
      document.getElementsByName("notas")[0].value = document.getElementById(
        "notas_" + id
      ).textContent;
      document.getElementsByName("danios")[0].value = document.getElementById(
        "danios_" + id
      ).textContent;
      document.getElementsByName("motor")[0].value = document.getElementById(
        "motor_" + id
      ).textContent;
      document.getElementsByName("chasis")[0].value = document.getElementById(
        "chasis_" + id
      ).textContent;
      document.getElementsByName("operacion")[0].value =
        document.getElementById("operacion_" + id).textContent;
      document.getElementsByName("importe")[0].value = document.getElementById(
        "importe_" + id
      ).textContent;
      document.getElementsByName("poliza")[0].value = document.getElementById(
        "poliza_" + id
      ).textContent;
      document.getElementsByName("sucursal")[0].value = document.getElementById(
        "sucursal_" + id
      ).textContent;
...
function enviarMensajeWPP() {
  ...
  window.open(
    "https://web.whatsapp.com/send?phone=549" +
      telefono +
      "&text=Hola,%20nos%20comunicamos%20de%20GIOIA%20Seguros.%20Por%20favor%20agend�%20nuestro%20n�mero%20para%20cualquier%20consulta%20o%20solicitud%20que%20tengas."
  );
}
...
function actualiEstado(event) {
  ...
  google.script.run.actualizarEstado(
    poliza_sn,
    operacion_sn,
    novedad_sn,
    usuario_sn,
...
document
  .getElementById("bt-modificar-datos")
  .addEventListener("click", modificarDatos);
document
  .getElementById("bt-actualizar_nota")
  .addEventListener("click", actualiEstado);
document
  .getElementById("close_session")
  .addEventListener("click", close_sessionok);
