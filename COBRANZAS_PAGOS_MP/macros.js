...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", infoVigencia, infoImporte, infoCnia, infoPoliza , newVtoDesde, newVtoHasta, "RENOVACION", newCob, infoMarca, "CUPONES", newNotas, , "RENOV. BD COB. (MARCOS PAZ)", nuevaFechaVence, newVtoDesde, newVtoHastaRefa]
...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", infoVigencia, infoImporte, infoCnia, infoPoliza , infoVence, newVtoHastaVence, "ENDOSO", newCob, infoMarca, "CUPONES", newNotas, , "ENDOSO X DATOS MAL BD COB. (MARCOS PAZ)", nuevaFechaVence, infoVence, newVtoHastaRefa, infoVigTot]
...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", infoVigencia, infoImporte, infoCnia, infoPoliza , VAL_POL[i][8], VAL_POL[i][9], "REFACTURACION", newCob, infoMarca, "CUPONES", newNotas, , "REFACTURA BD COB. (MARCOS PAZ)", newVtoDesdeRefa, newVtoDesdeRefa, newVtoHastaRefa, infoVigTot]
...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", infoVigencia, infoImporte, infoCnia, infoPoliza , newVtoDesde, newVtoHastaVence, "RENOVACION", newCob, infoMarca, "CUPONES", newNotas, , "RENOV. BD COB. (MARCOS PAZ)", nuevaFechaVence, nuevaFechaVence, newVtoHastaRefa, infoVigTot]
...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", , infoImporte, infoCnia, infoPoliza , nuevaFechaVence, newVtoHastaVence, "SEGURO NUEVO", , infoMarca, "CUPONES", , , "CARGA AUTOMATICA DE POLIZA NO CARGADA (BD COBRANZAS - MARCOS PAZ)", nuevaFechaVence, nuevaFechaVence, newVtoHastaRefa, infoVigTot]
