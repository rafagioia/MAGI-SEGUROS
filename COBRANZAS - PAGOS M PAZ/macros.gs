...
var vehVals = [infoPatente, infoDNI, infoCliente, "BD COBRANZAS", , infoImporte, infoCnia, infoPoliza , nuevaFechaVence, , "SEGURO NUEVO", , infoMarca, "CUPONES", , , , , ]
  ...
  if (infomultiRec > 1 && infomultiRec < 7) {
    for (var i = 0; i < infomultiRec; i++) {
      ...
      var sourceVals = [recibo, infoPatente, infoDNI, infoCliente, infoWpp, vtoNuevo, fecha, cuotaNum, infoVigencia, infoPoliza, infoCnia, infoImporte, infoPatente, infoMarca, ,infoColor, sucursal, "", notas1, infoMedio];
    ...
    var sourceVals = [recibo, infoPatente, infoDNI, infoCliente, infoWpp, infoVence, fecha, infoCuota, infoVigencia, infoPoliza, infoCnia, infoImporte, infoPatente, infoMarca, ,infoColor, sucursal, "", notas1, infoMedio];
    sheetRegistro2.insertRowBefore(2).getRange(2, 1, 1, sourceVals.length).setValues([sourceVals]);
