...
// Columna de POLIZA
if (result[i][12]) {
 pendientesHtml += "<div class='col-5  p-0'><input type='text' class='form-control text-sm planilla'  id='_pol" + i + "' value='" + result[i][11] + "'></div><div class='col-1' style='margin: auto' id='upd_pol" + i + "'>✔️</div>";
} else {
...
google.script.run.withSuccessHandler(function (fechaHoyPasada) {
     document.getElementById("upd_pol" + id).textContent = "✔️";
